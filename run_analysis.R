...
setwd("~/R/Coursera/Getting and Cleaning the Data/UCI HAR Dataset")
...
#Step 1: Merging the training and test datasets to create one data set
...
#Taking a look at the final data
str(FinalData)
View(FinalData)
